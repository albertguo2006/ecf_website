            ...
            function i(t, e) {
                return (function (t, e) {
                    var n,
                        ...
                        r = [],
                        i = []
                    for (r[15] = i[15] = void 0, 16 < o.length && (o = a(o, 8 * t.length)), n = 0; n < 16; n += 1)
    ...
    function w(t) {
        if (null !== t && "object" === e(t))
            return (
                t.src ? y(t.src)
                : t.href ? y(t.href)
                : t.innerText && "" !== t.innerText ? y(t.innerText)
                : void 0
            )
    }
    var v = "fa-kits-diag",
    ...
    function j(t) {
        ...
        console.group("Font Awesome Detector"),
            ...
            :   (console.info("Testing ".concat(i, " possible conflicts.")),
                ...
                console.info(
                    "\t%c".concat(O, "%c: milliseconds to wait for each test before deciding whether it's a conflict."),
                    "font-weight: bold;",
                    "font-size: normal;",
                ),
                console.info(
    ...
    var t = B(
        ...
        S =
            ...
            B(
                ...
                r(s, I, { "fa-solid": "fass", "fa-regular": "fasr", "fa-light": "fasl", "fa-thin": "fast" }),
                s),
            ),
            B(
            ...
            (function (t) {
                ...
                (function (t, e) {
                    if (t) {
                        ...
                        return (
                            "Map" === (n = "Object" === n && t.constructor ? t.constructor.name : n) || "Set" === n ?
                                Array.from(t)
                            : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? i(t, e)
                            : void 0
                        )
                    }
                })(z) ||
