...
!(function () {
    ...
    function e(t, a) {
        if (t) {
            ...
            return (
                "Map" === (e = "Object" === e && t.constructor ? t.constructor.name : e) || "Set" === e ? Array.from(t)
                : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? o(t, a)
                : void 0
            )
        }
    }
    ...
    function Ht(t, a) {
        ...
        a = t.reduce(function (t, a) {
            ...
            return (
                xt[a] ? ((a = Ot[o].includes(a) ? H[o][a] : a), (r = a), (t.prefix = a))
                : -1 < zt[o].indexOf(a) ? ((r = a), (t.prefix = Dt(a, { family: o })))
                : e ? (t.iconName = e)
                ...
                (e +=
                    c && w ?
                        "translate("
                            ...
                            .concat(o.y / Z - n / 2, "em) ")
                    : c ? "translate(calc(-50% + ".concat(o.x / Z, "em), calc(-50% + ").concat(o.y / Z, "em)) ")
        ...
        replace: function (t) {
            ...
            a.parentNode &&
                ...
                null === a.getAttribute(O) && J.keepOriginalSource ?
                    ((t = h.createComment(
                        ((t = " ".concat((t = a).outerHTML, " ")), (t = "".concat(t, "Font Awesome fontawesome.com "))),
                    )),
    ...
    function za(b, p) {
        ...
        return new Promise(function (e, t) {
            ...
            u && "none" !== d && "" !== d ?
                ...
                (n =
                    ~["Solid", "Regular", "Light", "Thin", "Duotone", "Brands", "Kit"].indexOf(u[2]) ?
                        D[a][u[2].toLowerCase()]
                    :   X[a][m]),
                (d = (l =
                    ((l = (d = s).replace(ja, "")),
                ...
                l &&
                    ((d = jt[(l = d)]),
                    (l = Lt("fas", l)),
                    (l = d || (l ? { prefix: "fas", iconName: l } : null) || { prefix: null, iconName: null })
                        .iconName &&
                        l.prefix &&
